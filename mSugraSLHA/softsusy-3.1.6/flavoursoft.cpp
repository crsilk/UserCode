...
void flavourBcs2(MssmSoftsusy & m, 
  ...
  int j; for (i=1; i<=3; i++)
    for (j=i; j<=3; j++) {
      count++;
      msq2in(j, i) = inputParameters.display(count);
    }
   for (i=1; i<=3; i++)
    for (j=i; j<=3; j++) {
      count++;
      msu2in(j, i) = inputParameters.display(count);
    }
   for (i=1; i<=3; i++)
    for (j=i; j<=3; j++) {
      count++;
      msd2in(j, i) = inputParameters.display(count);
    }
   for (i=1; i<=3; i++)
    for (j=i; j<=3; j++) {
      count++;
      msl2in(j, i) = inputParameters.display(count);
    }
   for (i=1; i<=3; i++)
    for (j=i; j<=3; j++) {
      count++;
      mse2in(j, i) = inputParameters.display(count);
    }
  msq2in.symmetrise();
  msu2in.symmetrise();
  msd2in.symmetrise();
  ...
  DoubleMatrix tuin(3, 3), tdin(3, 3), tein(3, 3);
   for (i=1; i<=3; i++)
    for (j=1; j<=3; j++) {
      count++;
      tuin(j, i) = inputParameters.display(count);
    }
   for (i=1; i<=3; i++)
    for (j=1; j<=3; j++) {
      count++;
      tdin(j, i) = inputParameters.display(count);
    }
  for (i=1; i<=3; i++)
    for (j=1; j<=3; j++) {
      count++;
      tein(j, i) = inputParameters.display(count);
    }
...
void FlavourMssmSoftsusy::lesHouchesAccordOutput(ostream & out, const char model[], 
  ...
  out << "     1    " << modsel << "   # " << model << "\n"; // SLHA code
  out << "     6    " << modsel << "   # flavour violating MSSM\n"; 
  ...
  out << "     5   "; printRow(out, d.displayMbMb()); 
  out << "   # mb(mb)\n";
