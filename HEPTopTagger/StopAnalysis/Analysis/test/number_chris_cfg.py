...
if options.appendTitle != '':
    if options.appendTitle == '_':
        outputFileName = options.appendTitle + "number_chris.root"
    else:
        outputFileName = options.appendTitle + "_number_chris.root"
else:
    outputFileName = "number_chris.root"
...
#        process.isolatedTrackVeto *
    ...
    process.requireTripletNoBJetVeto * 
    process.m123CutNoBJetVeto * 
    process.m23OverM123CutNoBJetVeto0p35 * 
    process.MTtNoBJetVetoAndMTb1000 *
    process.MT2NoBJetVetoCut300 *
    process.METCut175 *
...
#process.schedule = cms.Schedule( process.produce, process.out)
#process.schedule = cms.Schedule()
#process.schedule.extend([process.produce, process.cut, process.out])
