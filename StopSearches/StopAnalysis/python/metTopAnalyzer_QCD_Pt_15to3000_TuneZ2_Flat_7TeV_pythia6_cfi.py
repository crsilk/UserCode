...
metTopAnalyzer = cms.EDAnalyzer('METTopAnalyzer',
	...
	alphaTSrc = cms.InputTag( collectionSuffix, 'alphaT'),
	HTSrc = cms.InputTag( collectionSuffix, 'HT'),
	MHTSrc = cms.InputTag( collectionSuffix, 'MHTP4'),
	metTopDeltaPhiSrc = cms.InputTag( collectionSuffix, 'metTopDeltaPhi'),
	metTopMtSrc  = cms.InputTag( collectionSuffix, 'metTopMt'),
	topTagMatchMatrixSrc = cms.InputTag( collectionSuffix, 'topTagMatchMatrix'),
	wTagMatchMatrixSrc = cms.InputTag( collectionSuffix, 'wTagMatchMatrix'),
