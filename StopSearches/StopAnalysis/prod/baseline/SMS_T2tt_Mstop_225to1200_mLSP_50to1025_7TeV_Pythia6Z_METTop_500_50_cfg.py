...
process.TFileService = cms.Service("TFileService",
	fileName = cms.string("SMS_T2tt_Mstop_225to1200_mLSP_50to1025_7TeV_Pythia6Z_METTop_500_50.root")

)
process.metTopAnalyzer.modelParameters = cms.vdouble(500.0, 50.0)
