...
//////////////ADDED BY CHRISTOPHER SILKWORTH////////////////
   void pyupev_();
   void pyupin_();
   void pylhef_();
////////////////////////////////////////////////////////////
...
{ 
   ...
   //
///////////ADDED BY CHRISTOPHER SILKWORTH//////////
   fPythiaToLHEEnabled = false;
   if ( ps.exists( "pythiaToLHE" ) )
      fPythiaToLHEEnabled = ps.getParameter<bool>("pythiaToLHE") ;
///////////////////////////////////////////////////
